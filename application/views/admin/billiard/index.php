<table class="table table-striped" id="table-data">
    ...
    <tbody>
        <?php $no = 1; ?>
        <?php if( $billiard_tables->num_rows() >= 1 ): ?>
        <?php foreach( $billiard_tables->result() as $key => $value ): ?>
        <tr>
            <td class="text-center"><?php echo $no++; ?></td>
            <td><?php echo $value->billiard_table ?></td>
        ...
        <?php else: ?>
        <tr>
            <td colspan="3" align="center">Tidak Terdapat Data</td>
        </tr>
        <?php endif; ?>
    </tbody>
</table>